export type ProviderId = "claude" | "codex" | "cursor" | "copilot" | "grok" | "kimi" | "opencode" | "commandcode" | "zai" | "openrouter" | "phoenixgrove";
export declare const PROVIDER_IDS: readonly ["claude", "codex", "cursor", "copilot", "grok", "kimi", "opencode", "commandcode", "zai", "openrouter", "phoenixgrove"];
export type ProviderSource = "oauth" | "cli-rpc" | "api" | "web" | "cache" | "unavailable";
export type ProviderStatus = "fresh" | "stale" | "unavailable" | "auth_required" | "rate_limited" | "error";
/**
...
export type ProviderStateReason = "keychain_access_required" | "credentials_expired";
export type QuotaPaceStatus = "ahead" | "on_pace" | "behind" | "unknown";
export type QuotaPaceReason = "stale" | "missing_usage" | "missing_cycle" | "invalid_cycle" | "future_cycle_start" | "expired_reset" | "unsupported_period";
...
export type EffectiveRunway = {
     ...
     */
    status: "exhausted_now" | "projected_exhaustion" | "through_reset" | "unknown";
...
export type ProviderStateSummary = Pick<ProviderQuota["state"], "status" | "stale" | "authStatus" | "reason" | "remedyCommand">;
